...
Where:
- **R<sub>k</sub>** = Characteristic (5% fractile) resistance
- **γ<sub>M</sub>** = Partial safety factor for materials
- **R<sub>d</sub>** = Design resistance
...
<Note>
  Product ETAs may specify different γ<sub>Ms</sub> values. Clariti uses
...
<Warning>
  ...
  before entering N<sub>Ed</sub> and V<sub>Ed</sub>.
</Warning>
...
|--------|--------|---------|
| ψ<sub>0</sub> | Combination | Unlikely all actions at max simultaneously |
| ψ<sub>1</sub> | Frequent | Typical service conditions |
| ψ<sub>2</sub> | Quasi-permanent | Long-term average |
